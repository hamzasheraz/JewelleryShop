					...
					<div id='carousel-custom' className='carousel slide' data-ride='carousel'>
						<div className='carousel-outer'>
							...
							<div className='carousel-inner '>
								<div className='item active'>
									<img src='/src/images/shop/single-products/product-1.jpg' alt='' data-zoom-image="/src/images/shop/single-products/product-1.jpg" />
								</div>
								<div className='item'>
									<img src='/src/images/shop/single-products/product-2.jpg' alt='' data-zoom-image="/src/images/shop/single-products/product-2.jpg" />
								</div>
								
								<div className='item'>
									<img src='/src/images/shop/single-products/product-3.jpg' alt='' data-zoom-image="/src/images/shop/single-products/product-3.jpg" />
								</div>
								<div className='item'>
									<img src='/src/images/shop/single-products/product-4.jpg' alt='' data-zoom-image="/src/images/shop/single-products/product-4.jpg" />
								</div>
								<div className='item'>
									<img src='/src/images/shop/single-products/product-5.jpg' alt='' data-zoom-image="/src/images/shop/single-products/product-5.jpg" />
								</div>
								<div className='item'>
									<img src='/src/images/shop/single-products/product-6.jpg' alt='' data-zoom-image="/src/images/shop/single-products/product-6.jpg" />
								</div>
						...
						<ol className='carousel-indicators mCustomScrollbar meartlab'>
							<li data-target='#carousel-custom' data-slide-to='0' className='active'>
								<img src='/src/images/shop/single-products/product-1.jpg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='1'>
								<img src='/src/images/shop/single-products/product-2.jpg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='2'>
								<img src='/src/images/shop/single-products/product-3.jpg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='3'>
								<img src='/src/images/shop/single-products/product-4.jpg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='4'>
								<img src='/src/images/shop/single-products/product-5.jpg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='5'>
								<img src='/src/images/shop/single-products/product-6.jpg' alt='' />
							</li>
							<li data-target='#carousel-custom' data-slide-to='6'>
								<img src='/src/images/shop/single-products/product-7.jpg' alt='' />
							</li>
						</ol>
					</div>
				</div>
						    	...
						    	<ul className="media-list comments-list m-bot-50 clearlist">
								    ...
								    <li className="media">
								        ...
								        <a className="pull-left" href="#!">
								            <img className="media-object comment-avatar" src="/src/images/blog/avater-1.jpg" alt="" width="50" height="50" />
								        </a>
								    ...
								    <li className="media">
								        ...
								        <a className="pull-left" href="#!">
								            <img className="media-object comment-avatar" src="/src/images/blog/avater-4.jpg" alt="" width="50" height="50" />
								        </a>
