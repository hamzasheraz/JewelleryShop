                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr className="">
                      <td className="">
                        <div className="product-info">
                          <img width="80" src="/src/images/shop/cart/cart-1.jpg" alt="" />
                          <a href="#!">Sunglass</a>
                        </div>
                      </td>
                    ...
                    <tr className="">
                      <td className="">
                        <div className="product-info">
                          <img width="80" src="/src/images/shop/cart/cart-2.jpg" alt="" />
                          <a href="#!">Airspace</a>
                        </div>
                      </td>
                      <td className="">$200.00</td>
                    ...
                    <tr className="">
                      <td className="">
                        <div className="product-info">
                          <img width="80" src="/src/images/shop/cart/cart-3.jpg" alt="" />
                          <a href="#!">Bingo</a>
                        </div>
                      </td>
                      <td className="">$200.00</td>
